	...
	Light(shadowWidth, shadowHeight, red, green, blue, aIntensity, dIntensity)
{
	...
	depthMap = new OmniShadowMap();
	depthMap->Init(shadowWidth, shadowHeight);
}

void PointLight::UseLight(GLuint ambientColorLocation, GLuint ambientIntensityLocation, 
...
std::vector<glm::mat4> PointLight::CalculateLightTransform()
{
	...
	// Use conventional up vectors for cube map faces to ensure correct orientation
